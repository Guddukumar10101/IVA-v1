  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        ...
        <div>
          ...
          <p className="text-[var(--muted-foreground)] leading-relaxed text-sm md:text-base">
            IVA is dedicated  for student's empowerments  with quality
        ...
        <div>
          ...
          <ul className="space-y-2 text-[var(--muted-foreground)] mb-5">
            <li className="flex justify-center md:justify-start items-center gap-2">
              <Phone size={18} /> +91 8197013384, +91 6202677217
            </li>
            <li className="flex justify-center md:justify-start items-center gap-2">
              <Mail size={18} /> info@ivworlds.com, inspirdvisionacademy@gmai.com
            </li>
            <li className="flex justify-center md:justify-start items-center gap-2">
              <MapPin size={18} /> Inspired Vision Academy, Naya Toli Simaliya Near ICFAI University Daladali Chowk Ranchi,Jharkhand -835222
            </li>
          </ul>
      ...
      <div className="mt-12 border-t border-[var(--border)] pt-6 text-center text-sm text-[var(--muted-foreground)]">
        © {new Date().getFullYear()} Inspired Vision Academy . All rights reserved.
      </div>
    </motion.footer>
  );
};
