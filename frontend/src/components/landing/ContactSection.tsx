          ...
          >
            <div className="bg-white/5 p-6 rounded-2xl shadow-lg border border-white/10">
              ...
              <p className="text-[var(--muted-foreground)] flex items-center gap-2">
                ...
                Inspired Vision Academy, Naya Toli Simaliya Near ICFAI University Daladali Chowk Ranchi,Jharkhand -835222
              </p>
              <p className="text-[var(--muted-foreground)] flex items-center gap-2 mt-2">
                <Phone className="w-5 h-5 text-[var(--primary)]" /> +91 8197013384 , +91 6202677217
              </p>
              <p className="text-[var(--muted-foreground)] flex items-center gap-2 mt-2">
                <Mail className="w-5 h-5 text-[var(--primary)]" />{" "}
                info@ivworlds.com , inspirdvisionacademy@gmail.com
              </p>
            </div>
