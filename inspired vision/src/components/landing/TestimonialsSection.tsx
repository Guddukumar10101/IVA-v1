    ...
    <section className="relative py-24 px-6 lg:px-24 bg-[var(--background)]">
      <div className="max-w-6xl mx-auto text-center">
        ...
        >
          ...
          {/* Heading */}
          <h2 className="text-3xl md:text-5xl font-extrabold tracking-tight text-transparent 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-16">
          {testimonials.map((t, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group relative bg-[var(--card)] p-6 rounded-2xl 
              shadow-xl border border-[var(--border)] hover:shadow-2xl 
