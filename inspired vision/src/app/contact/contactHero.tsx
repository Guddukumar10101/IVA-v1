      ...
      <div className="py-16 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-lg">
            Whether you're a student, parent, or partner — we are always here to help. Let’s connect today.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                contact: '01, Ground Floor, Pragati Path, Ranchi - 834001',
